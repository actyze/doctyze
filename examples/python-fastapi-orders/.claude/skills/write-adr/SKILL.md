---
name: write-adr
description: Use when adding a new external dependency, swapping a major architectural
  component, or making a non-obvious design choice. Captures the decision in MADR
  format under docs/architecture/decisions/.
---

<!-- Generated by Doctyze from docs/skills/write-adr.md. Do not edit by hand — edit the canonical source. -->
