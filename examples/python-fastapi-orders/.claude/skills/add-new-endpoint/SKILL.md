...
description: Use when adding a new HTTP endpoint or changing an existing endpoint's
  public contract. Ensures docs/api/openapi.yaml, specs, and runbooks update in the
  same PR.
---

<!-- Generated by Doctyze from docs/skills/add-new-endpoint.md. Do not edit by hand — edit the canonical source. -->
