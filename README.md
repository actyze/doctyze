...
2. **Generates** the missing docs from the actual code: technical feature specs, narrative product documentation (a curated, Docusaurus-ready set for product owners/users, tied to the technical specs), architecture + Mermaid diagrams, decisions (ADRs), runbooks, observability, dev/testing skills.
...
$ uvx doctyze init                 # install skills + scaffold docs/  (one time)
  ...
  ↳ reads your code and writes:       technical specs · product docs · architecture + Mermaid ·
